...
#### adjacent dispersion model for heart data with regularization new
...
maxpl<-max(cov)
minpl<-min(cov)
plot(log(1+lambdav),cov[,1], type="b", ylim=c(minpl,maxpl),ylab="",xlab="",cex.lab=1.6,
     cex.axis=1.4,lwd=1.5, cex=1.2,pch = 1)
#title(ylab=(paste("variable",v)), line=2.32, cex.lab=1.7)
for( r in 2:p)lines(log(1+lambdav),cov[,r], type="b", cex.lab=1.7,lwd=2, cex=1.2,pch = 1)
title(xlab=(paste("log(1+lambda)")), cex.lab=1.7,lwd=2, cex=1.2)
title(ylab=(paste("Location")), cex.lab=1.7,lwd=2, cex=1.2)

maxpl<-max(covdisp)
minpl<-min(covdisp)
plot(log(1+lambdav),covdisp[,1], type="b", ylim=c(minpl,maxpl),ylab="",xlab="",
     cex.lab=1.6,cex.axis=1.4,lwd=1.5, cex=1.2,pch = 1)
#title(ylab=(paste("variable",v)), line=2.32, cex.lab=1.7)
for( r in 2:p)lines(log(1+lambdav),covdisp[,r], type="b", cex.lab=1.7,lwd=2, cex=1.2,pch = 1)
title(xlab=(paste("log(1+lambda)")), cex.lab=1.7,lwd=2, cex=1.2)
title(ylab=(paste("Dispersion")), cex.lab=1.7,lwd=2, cex=1.2)

#### plot cross
plot(log(1+lambdav),-loglikv,type='b',xlab="",ylab="",cex.lab=1.6,cex.axis=1.4,lwd=1.5, cex=1.5,pch = 1)
title(xlab=(paste("log(1+lambda)")), cex.lab=1.7,lwd=2, cex=1.2)
